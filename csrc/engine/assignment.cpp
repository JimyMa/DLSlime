...
//     size_t batch_size = source_offset.size();
...
//         std::vector<uint64_t> split_target_ofsets = vector_slice(target_offset, i, i + step);
//         std::vector<uint64_t> split_source_ofsets = vector_slice(source_offset, i, i + step);
