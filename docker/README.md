...
```bash
cat >> docker/.env <<'EOF'
DLSLIME_CTRL_IMAGE=ghcr.io/jimyma/dlslime-ctrl:0.1.23
...
| Push tag `v0.1.23`         | `0.1.23`, `0.1`, `latest`, `sha-<short>` |
...
The workflow will build `linux/amd64` + `linux/arm64` and push `0.1.23`, `0.1`, `latest`.
